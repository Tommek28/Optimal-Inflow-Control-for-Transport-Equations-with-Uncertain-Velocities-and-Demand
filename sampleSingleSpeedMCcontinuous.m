function [L1_error_mean,L2_error_mean,L3_error_mean,mean_out,mean_X,lambda,X,u]  = sampleSingleSpeedMCcontinuous(T,alpha,beta,MCruns,theta_fun,d0,kappa,sigma,dt,dtU,plotBool,ii,velocityShift,proxy,randeinzug)
...
% delta!
if proxy
    u = computeOptimalU_continuous_2(t_gridU, d0, kappa, theta_fun, alpha, beta, 5*10^-4,0,[2-1000*eps,2+1000*eps]);
else
    u = computeOptimalU_continuous_2(t_gridU, d0, kappa, theta_fun, alpha, beta, 5*10^-4,0,velocityShift);
end
